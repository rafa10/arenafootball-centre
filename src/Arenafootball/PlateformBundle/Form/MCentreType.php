...
class MCentreType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('ville',       'text',    array('attr' => array('placeholder' => 'Saisier la ville du centre')))
            ...
            ->add('description', 'textarea',array('attr' => array('placeholder' => 'Saisier la description du centre')))            

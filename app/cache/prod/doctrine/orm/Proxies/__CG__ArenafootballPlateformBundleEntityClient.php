 ...
 */
class Client extends \Arenafootball\PlateformBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Arenafootball\\PlateformBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'Arenafootball\\PlateformBundle\\Entity\\Client' . "\0" . 'civilite', '' . "\0" . 'Arenafootball\\PlateformBundle\\Entity\\Client' . "\0" . 'nom', '' . "\0" . 'Arenafootball\\PlateformBundle\\Entity\\Client' . "\0" . 'prenom', '' . "\0" . 'Arenafootball\\PlateformBundle\\Entity\\Client' . "\0" . 'phone', '' . "\0" . 'Arenafootball\\PlateformBundle\\Entity\\Client' . "\0" . 'login', '' . "\0" . 'Arenafootball\\PlateformBundle\\Entity\\Client' . "\0" . 'password', '' . "\0" . 'Arenafootball\\PlateformBundle\\Entity\\Client' . "\0" . 'status');
        }

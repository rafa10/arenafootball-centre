...
class appProdDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'arenafooahbase.mysql.db', 'port' => NULL, 'dbname' => 'arenafooahbase', 'user' => 'arenafooahbase', 'password' => 'Rafa09312308', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Arenafootball/PlateformBundle/Entity'))), 'Arenafootball\\PlateformBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ArenafootballPlateformBundle' => 'Arenafootball\\PlateformBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3625d3825ce8cba0bddcfaab4bc3dafd84bfd68c533661ad898da7a4db23a179');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $h, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($h, '/arenafootball'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'logout'));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('support@arenafootball-centre.com');
        $a->setPassword('rafa09312308');
        $a->setAuthMode('login');

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('smtp.arenafootball-centre.com');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Arenafootball/PlateformBundle/Resources/views'), 'ArenafootballPlateform');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1413b3c271c59dfce10c9d008d4518bc');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ArenafootballPlateformBundle' => 'Arenafootball\\PlateformBundle\\ArenafootballPlateformBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdDebugProjectContainer',
            'database_driver' => 'pdo_mysql',
            'database_host' => 'arenafooahbase.mysql.db',
            'database_port' => NULL,
            'database_name' => 'arenafooahbase',
            'database_user' => 'arenafooahbase',
            'database_password' => 'Rafa09312308',
            'mailer_transport' => 'smtp',
            'mailer_auth_mode' => 'login',
            'mailer_host' => 'smtp.arenafootball-centre.com',
            'mailer_port' => 587,
            'mailer_user' => 'support@arenafootball-centre.com',
            'mailer_password' => 'rafa09312308',
            'locale' => 'fr',
            'secret' => '1413b3c271c59dfce10c9d008d4518bc',
            'database_path' => NULL,
            ...
            'kernel.secret' => '1413b3c271c59dfce10c9d008d4518bc',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtp.arenafootball-centre.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'support@arenafootball-centre.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'rafa09312308',
